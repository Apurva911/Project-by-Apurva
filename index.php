<?php  include ('header.php');
	...
	$ofset=($page-1)*$limit;
	//---------
    $sql="SELECT * FROM blog LEFT JOIN categories ON blog.category=categories.cat_id LEFT JOIN user ON blog.author_id=user.user_id ORDER BY blog.publish_date DESC  limit $ofset,$limit";
